...
{
    _glCreateShader = (PFNGLCreateShader)glGetProcAddress((const GLubyte*)"glCreateShader");
    _glDeleteShader = (PFNGLDeleteShader)glGetProcAddress((const GLubyte*)"glDeleteShader");
    _glShaderSource = (PFNGLShaderSource)glGetProcAddress((const GLubyte*)"glShaderSource"); 
    _glCompileShader = (PFNGLCompileShader)glGetProcAddress((const GLubyte*)"glCompileShader");
    _glAttachShader = (PFNGLAttachShader)glGetProcAddress((const GLubyte*)"glAttachShader"); 
    _glCreateProgram = (PFNGLCreateProgram)glGetProcAddress((const GLubyte*)"glCreateProgram");
    _glLinkProgram = (PFNGLLinkProgram)glGetProcAddress((const GLubyte*)"glLinkProgram");
    _glUseProgram = (PFNGLUseProgram)glGetProcAddress((const GLubyte*)"glUseProgram");
    _glDeleteProgram = (PFNGLDeleteProgram)glGetProcAddress((const GLubyte*)"glDeleteProgram");
    _glGenBuffers = (PFNGLGenBuffers)glGetProcAddress((const GLubyte*)"glGenBuffers");
    _glBindBuffer = (PFNGLBindBuffer)glGetProcAddress((const GLubyte*)"glBindBuffer");
    _glVertexAttribPointer = (PFNGLVertexAttribPointer)glGetProcAddress((const GLubyte*)"glVertexAttribPointer");
    _glEnableVertexAttribArray = (PFNGLEnableVertexAttribArray)glGetProcAddress((const GLubyte*)"glEnableVertexAttribArray");
    _glGenVertexArrays = (PFNGLGenVertexArrays)glGetProcAddress((const GLubyte*)"glGenVertexArrays");
    _glBindVertexArray = (PFNGLBindVertexArray)glGetProcAddress((const GLubyte*)"glBindVertexArray");
    _glDeleteVertexArrays = (PFNGLDeleteVertexArrays)glGetProcAddress((const GLubyte*)"glDeleteVertexArrays");
    _glGetAttribLocation = (PFNGLGetAttribLocation)glGetProcAddress((const GLubyte*)"glGetAttribLocation");
    _glGetUniformLocation = (PFNGLGetUniformLocation)glGetProcAddress((const GLubyte*)"glGetUniformLocation");
    _glUniform1f = (PFNGLUniform1f)glGetProcAddress((const GLubyte*)"glUniform1f");
    _glUniform3f = (PFNGLUniform3f)glGetProcAddress((const GLubyte*)"glUniform3f");
    _glBufferData = (PFNGLBufferData)glGetProcAddress((const GLubyte*)"glBufferData");
    _glDeleteBuffers = (PFNGLDeleteBuffers)glGetProcAddress((const GLubyte*)"glDeleteBuffers");
...
int main()
{
    ...
    sdlWindow = SDL_CreateWindow("Ant",
