...
// that on Mac Lion backward compatibility is not ensured.
        ...
        "void main() { gl_FragColor.rgb = fcolor.bgr; gl_FragColor.a = fcolor.a * texture(tex, fuv).r; }"
#else
        "void main() { gl_FragColor.rgb = fcolor.bgr; gl_FragColor.a = fcolor.a * texture2D(tex, fuv).r; }"
#endif
    };
